package com.supi.mh.security.shiro.config;

import com.supi.mh.security.shiro.credentials.CredentialsMatcher;
import com.supi.mh.security.shiro.realm.AuthRealm;
...
public class shiroConfiguration {
    ...
    public ShiroFilterFactoryBean shiroFilter(@Qualifier("securityManager") SecurityManager manager) {
        ...
        //配置登录的url和登录成功的url
        bean.setLoginUrl("/login/v1/nologin");
//        bean.setSuccessUrl("/home");
        //配置访问权限
        LinkedHashMap<String, String> filterChainDefinitionMap=new LinkedHashMap<>();
        filterChainDefinitionMap.put("/login/v1", "anon");
...
//        测试一下
        filterChainDefinitionMap.put("/login/v1/hello", "user");
        filterChainDefinitionMap.put("/email/v1/toadmin", "user");
